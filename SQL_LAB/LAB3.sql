...
SELECT SNAME FROM STUDENT
WHERE CITY IN (' RAJKOT', 'RAJKOT',' SURAT')
...
SELECT * FROM STUDENT 
WHERE SPI>7.5 AND STDID BETWEEN 100 AND 110 AND CITY IN(' RAJKOT', 'RAJKOT',' SURAT')
--28. Display details of students who belong to ‘CIVIL’ or ‘MECHANICAL’ branch and SPI is greater than 8.0.

SELECT * FROM STUDENT 
WHERE BRANCH IN (' CIVIL', ' MECHANICAL') AND SPI >8
